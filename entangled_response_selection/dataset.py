...
class SelectionDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return transformed_text, labels

    def batchify_join_str(self, batch):
        text_token_ids_list_batch, text_input_masks_list_batch, text_segment_ids_list_batch, labels_batch = [], [], [], []
        for sample in batch:
        ...
        long_tensors = [text_token_ids_list_batch, text_input_masks_list_batch, text_segment_ids_list_batch, labels_batch]
